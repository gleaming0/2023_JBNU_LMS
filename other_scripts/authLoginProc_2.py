...
sys.stdout = open('./output/login_5.txt', 'w', encoding='utf-8')
...
group = "https://ieilms.jbnu.ac.kr/login/storeCookies.jsp"
...
my_headers = {  
                ...
                'Referer':'https://ieilms.jbnu.ac.kr/mypage/group/',
                'Accept-Encoding':'gzip, deflate',
                'Accept-Language':'en-US,en;q=0.9'
                }

response = requests.get(url=group, headers=my_headers)

print("====================================\tCookie\t\t====================================")
print(my_headers['Cookie'])
print("JSESSIONID=1234FD2F714C46FBB398600159AD32C1.i-12343da02702cd919")
print("====================================\tResponse\t====================================")
print(response)
print(response.text)